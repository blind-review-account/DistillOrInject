...
from local_datasets.java250 import get_split_datasets_java250
...
def create_data_loaders(config):
    ...
    datasets = get_split_datasets_java250(
        model_name = model_name,
        use_model_subfolder = use_model_subfolder,
        dataset_path = dataset_path,
        orig_suffix = data_config["orig_suffix"],
...
def launch_training(config, wandb_config):
    ...
    #Assume the value of training_config["save_dir"] is "./experimental_results/java250/Inject"
